...
// or
const displayNames = [];
zooAnimals.forEach((info)=>displayNames.push(`Name: ${info.animal_name}, Scientific: ${info.scientific_name}`));
console.log(displayNames);
...
*/
// const populationTotal = zooAnimals.reduce(function(a,b){return a + b.population;
// }, 0);
